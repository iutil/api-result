...
public class CodeMsg {
    ...
    /*------------------------common error---------------------------------*/
    /* 500 */
    static final BaseCodeMsg ERROR_COMMON_INTERNAL_SERVICE_ERROR = BaseCodeMsg.app(500100, "内部服务错误");

    /*------------------------user error---------------------------------*/

    /* user account not found */
    static final BaseCodeMsg ERROR_USER_ACCOUNT_NOT_FOUND = BaseCodeMsg.app(10001, "该账号未注册");
